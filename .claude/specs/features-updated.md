# Features (proposed update)

This is a draft for updating `manual/src/main/paradox/features.md`.

Changes compared to the current version:
- Expanded load balancing options (12 strategies instead of 4)
- Added Coraza WAF section
- Added Workflow engine
- Added GreenScore
- Added GraphQL/gRPC support details
- Added WebSocket support
- Expanded data exporters list (25 types)
- Expanded vault support (12 providers)
- Added Biscuit, OpenFGA, HMAC, fail2ban, WebAuthn
- Added body/data transformation section
- Expanded service discovery
- Added dynamic HTTP listeners
- Improved clustering section
- General reorganization and deduplication

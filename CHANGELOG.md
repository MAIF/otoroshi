...
## [18.0.0-preview8] - 2026-09-22


https://github.com/MAIF/otoroshi/milestone/141?closed=1
https://github.com/MAIF/otoroshi/compare/v18.0.0-preview7...v18.0.0-preview8
https://github.com/MAIF/otoroshi/releases/tag/v18.0.0-preview8
...
- Open user analytics to additional queries and projections from extensions (#2656 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- let user select captured events in `User Analytics` data exporter (#2657 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- Support trusted proxies and extract trusted ip address (#2669 fixed by [mathieuancelin](https://github.com/mathieuancelin))       
...
- `APIs`: streamline API configuration with (#2480 fixed by )
- fix `createOtoroshiRoute` flaky creation check (#2670 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- Log the effective trusted proxies at startup (#2676 fixed by [mathieuancelin](https://github.com/mathieuancelin))       
...
- brotli compression plugin does not work on apple silicon (#2677 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- `ForwardedHeader` plugin emits a `Forwarded` header that does not follow RFC 7239 (#2673 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- `RevokedApiKeyUsageAlert`: `from` and `fromOrigin` use two different addresses (#2674 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- Align address matching in IP filters and trusted proxies (#2675 fixed by [mathieuancelin](https://github.com/mathieuancelin))       
...
## [18.0.0-preview7] - 2026-09-14


https://github.com/MAIF/otoroshi/milestone/141?closed=1
https://github.com/MAIF/otoroshi/compare/v18.0.0-preview6...v18.0.0-preview7
https://github.com/MAIF/otoroshi/releases/tag/v18.0.0-preview7

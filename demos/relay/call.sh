...
curl -H 'Host: service-d-next-gen.oto.tools' http://127.0.0.1:8081/
curl -H 'Host: service-d-next-gen.oto.tools' http://127.0.0.1:8084/
curl -H 'Host: service-d-next-gen.oto.tools' http://127.0.0.1:8082/
curl -H 'Host: service-d-next-gen.oto.tools' http://127.0.0.1:8085/
...
curl -H 'Host: service-c-next-gen.oto.tools' http://127.0.0.1:8083/
curl -H 'Host: service-d-next-gen.oto.tools' http://127.0.0.1:8083/
...
curl -H 'Host: service-c-next-gen.oto.tools' http://127.0.0.1:8086/
curl -H 'Host: service-d-next-gen.oto.tools' http://127.0.0.1:8086/
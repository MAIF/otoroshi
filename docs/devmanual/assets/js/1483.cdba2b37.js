"use strict";(self.webpackChunkotoroshi_documentation=self.webpackChunkotoroshi_documentation||[]).push([["1483"],{77454(e,t,a){function i(e,t){e.accDescr&&t.setAccDescription?.(e.accDescr),e.accTitle&&t.setAccTitle?.(e.accTitle),e.title&&t.setDiagramTitle?.(e.title)}a.d(t,{S:()=>i}),(0,a(86827).K)(i,"populateCommonDb")},76806(e,t,a){a.d(t,{diagram:()=>v});var i=a(77454),l=a(5637),r=a(41916),n=a(34599),o=a(31293),s=a(86827),c=a(78731),d=a(47829),p=n.UI.pie,h={sections:new Map,showData:!1,config:p},g=h.sections,u=h.showData,f=structuredClone(p),m=(0,s.K)(()=>structuredClone(f),"getConfig"),$=(0,s.K)(()=>{g=new Map,u=h.showData,(0,n.IU)()},"clear"),x=(0,s.K)(({label:e,value:t})=>{if(t<0)throw Error(`"${e}" has invalid value: ${t}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);g.has(e)||(g.set(e,t),o.R.debug(`added new section: ${e}, with value: ${t}`))},"addSection"),w=(0,s.K)(()=>g,"getSections"),S=(0,s.K)(e=>{u=e},"setShowData"),y=(0,s.K)(()=>u,"getShowData"),b={getConfig:m,clear:$,setDiagramTitle:n.ke,getDiagramTitle:n.ab,setAccTitle:n.SV,getAccTitle:n.iN,setAccDescription:n.EI,getAccDescription:n.m7,addSection:x,getSections:w,setShowData:S,getShowData:y},C=(0,s.K)((e,t)=>{(0,i.S)(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},"populateDb"),D={parse:(0,s.K)(async e=>{let t=await (0,c.qg)("pie",e);o.R.debug(t),C(t,b)},"parse")},T=(0,s.K)(e=>`
  .pieCircle{

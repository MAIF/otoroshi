...
<Image src="/img/docs/deploy-cc-2.png" />

Finally, choose a name for your app

<Image src="/img/docs/deploy-cc-3.png" />
...
<Image src="/img/docs/deploy-cc-4-bis.png" />

You can also use expert mode :

<Image src="/img/docs/deploy-cc-4.png" />

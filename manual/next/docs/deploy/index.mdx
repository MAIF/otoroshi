...
<div class="provider-card">
  ...
  <div class="provider-card-img"><Image src="https://www.cloud-apim.com/assets/logo/512x512.png" alt="Cloud APIM" /></div>
...
<div class="provider-card">
  ...
  <div class="provider-card-img"><Image src="/img/docs/clever-cloud.png" alt="Clever Cloud" /></div>
...
<div class="provider-card">
  ...
  <div class="provider-card-img"><Image src="/img/docs/kubernetes.png" alt="Kubernetes" /></div>
...
<div class="provider-card">
  ...
  <div class="provider-card-img"><Image src="/img/docs/elastic-beanstalk.png" alt="AWS Elastic Beanstalk" /></div>
...
<div class="provider-card">
  ...
  <div class="provider-card-img"><Image src="/img/docs/amazon-ecs.png" alt="Amazon ECS" /></div>
...
<div class="provider-card">
  ...
  <div class="provider-card-img"><Image src="/img/docs/google.jpeg" alt="Google Cloud" /></div>
...
<div class="provider-card">
  ...
  <div class="provider-card-img"><Image src="/img/docs/azure-container-service.png" alt="Azure" /></div>
...
<div class="provider-card">
  ...
  <div class="provider-card-img"><Image src="/img/docs/heroku.png" alt="Heroku" /></div>
...
<div class="provider-card">
  ...
  <p>Deploy the Docker image using Docker integration</p>
  <div class="provider-card-img"><Image src="/img/docs/cloudfoundry.png" alt="CloudFoundry" /></div>
...
<div class="provider-card">
  ...
  <div class="provider-card-actions"><a href="https://www.playframework.com/documentation/3.0.x/ProductionConfiguration">Production Config</a> <a href="../install/get-otoroshi#from-zip">Distribution</a></div>
</div>
</div>
...
<div class="provider-card">
  ...
  <div class="provider-card-img"><Image src="/img/docs/clustering.png" alt="Clustering" /></div>
...
<div class="provider-card">
  ...
  <div class="provider-card-img"><Image src="/img/docs/scaling.png" alt="Scaling" /></div>

...
:::
rbac.yaml
:   > **Included file**: `../snippets/kubernetes/kustomize/base/rbac.yaml` 

crds.yaml
:   > **Included file**: `../snippets/kubernetes/kustomize/base/crds.yaml` 

redis.yaml
:   > **Included file**: `../snippets/kubernetes/kustomize/base/redis.yaml` 
...
deployment.yaml
:   > **Included file**: `../snippets/kubernetes/kustomize/overlays/simple/deployment.yaml` 

dns.example
:   > **Included file**: `../snippets/kubernetes/kustomize/overlays/simple/dns.example` 
...
deployment.yaml
:   > **Included file**: `../snippets/kubernetes/kustomize/overlays/simple-baremetal/deployment.yaml` 

haproxy.example
:   > **Included file**: `../snippets/kubernetes/kustomize/overlays/simple-baremetal/haproxy.example` 

nginx.example
:   > **Included file**: `../snippets/kubernetes/kustomize/overlays/simple-baremetal/nginx.example` 

dns.example
:   > **Included file**: `../snippets/kubernetes/kustomize/overlays/simple-baremetal/dns.example` 
...
deployment.yaml
:   > **Included file**: `../snippets/kubernetes/kustomize/overlays/simple-baremetal-daemonset/deployment.yaml` 

haproxy.example
:   > **Included file**: `../snippets/kubernetes/kustomize/overlays/simple-baremetal-daemonset/haproxy.example` 

nginx.example
:   > **Included file**: `../snippets/kubernetes/kustomize/overlays/simple-baremetal-daemonset/nginx.example` 

dns.example
:   > **Included file**: `../snippets/kubernetes/kustomize/overlays/simple-baremetal-daemonset/dns.example` 
...
deployment.yaml
:   > **Included file**: `../snippets/kubernetes/kustomize/overlays/cluster/deployment.yaml` 

dns.example
:   > **Included file**: `../snippets/kubernetes/kustomize/overlays/cluster/dns.example` 
...
deployment.yaml
:   > **Included file**: `../snippets/kubernetes/kustomize/overlays/cluster-baremetal/deployment.yaml` 

nginx.example
:   > **Included file**: `../snippets/kubernetes/kustomize/overlays/cluster-baremetal/nginx.example` 

dns.example
:   > **Included file**: `../snippets/kubernetes/kustomize/overlays/cluster-baremetal/dns.example` 
...
deployment.yaml
:   > **Included file**: `../snippets/kubernetes/kustomize/overlays/cluster-baremetal-daemonset/deployment.yaml` 

nginx.example
:   > **Included file**: `../snippets/kubernetes/kustomize/overlays/cluster-baremetal-daemonset/nginx.example` 

dns.example
:   > **Included file**: `../snippets/kubernetes/kustomize/overlays/cluster-baremetal-daemonset/dns.example` 
...
group.yaml
:   > **Included file**: `../snippets/crds/group.yaml` 

apikey.yaml
:   > **Included file**: `../snippets/crds/apikey.yaml` 

service-descriptor.yaml
:   > **Included file**: `../snippets/crds/service-descriptor.yaml` 

certificate.yaml
:   > **Included file**: `../snippets/crds/certificate.yaml` 

jwt.yaml
:   > **Included file**: `../snippets/crds/jwt.yaml` 

auth.yaml
:   > **Included file**: `../snippets/crds/auth.yaml` 

organization.yaml
:   > **Included file**: `../snippets/crds/organization.yaml` 

team.yaml
:   > **Included file**: `../snippets/crds/team.yaml` 
...
coredns.yaml
:   > **Included file**: `../snippets/kubernetes/kustomize/base/coredns.yaml`
...
:   > **Included file**: `../snippets/kubernetes/kustomize/base/validation-webhook.yaml`
...
:   > **Included file**: `../snippets/kubernetes/kustomize/base/sidecar-webhook.yaml`
...
sidecar.yaml
:   > **Included file**: `../snippets/kubernetes/kustomize/base/sidecar.yaml`
...
<div align="center">
<img src="/img/docs/kubernetes-daikoku-integration-enabled.png" />
</div>

then when a user subscribe for an apikey, he will only see an integration token

<div align="center">
<img src="/img/docs/kubernetes-daikoku-integration-token.png" />
</div>
...
:::
For the full documentation — including supported filters, configuration reference, current limitations, and troubleshooting — see [Kubernetes Gateway API support](../topics/kubernetes-gateway-api.md).

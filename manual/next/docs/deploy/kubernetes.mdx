...
import { TabItemWithVersion } from '@site/src/components/TabItemWithVersion';
...
<Tabs>
<TabItemWithVersion value="deployment.yaml" label="deployment.yaml" default>

```yaml include=../snippets/kubernetes/kustomize/overlays/simple/deployment.yaml
```

</TabItemWithVersion>
<TabItemWithVersion value="dns.example" label="dns.example">

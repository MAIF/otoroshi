...
4. Published [consumer plans](#plans) inject the appropriate security plugins (API key validation, JWT verification, mTLS checks, etc.) into each route automatically

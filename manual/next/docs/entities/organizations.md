...
Organizations (also called tenants) are the highest level for grouping resources in Otoroshi. Every entity in Otoroshi belongs to an organization and one or more [teams](./teams.md).
...
* [Teams](./teams.md) - Teams exist within organizations and provide a second level of grouping

...
:::warning
Service Descriptors are now deprecated and will sunset soon (probably in 2026). You can use [Routes](./routes.md) instead. You can read more about sunsetting Service Descriptors [here](../topics/deprecating-sd.md). 
:::

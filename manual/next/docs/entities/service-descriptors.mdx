...
- **[APIs](./apis.md)** group multiple routes together for full API management, providing a higher-level abstraction when you need to manage an entire API surface as a single unit.

...
:::warning
Service Descriptors are now deprecated and will sunset soon (probably in 2026). You can use [Routes](./routes.md) instead. You can read more about sunsetting Service Descriptors [here](../topics/deprecating-sd.mdx). 
:::
...
You can read more about the migration process in the [Sunsetting Service Descriptors](../topics/deprecating-sd.mdx) topic.

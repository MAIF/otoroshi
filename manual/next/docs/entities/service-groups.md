...
* [API Keys](./apikeys.md) - API keys reference groups in their `authorizedEntities` field
* [APIs](./apis.md) - APIs also create virtual groups automatically for their routes

...
In Otoroshi, all resources are attached to an [Organization](./organizations.mdx) and one or more Teams. Teams provide a second level of grouping within an organization, allowing you to control visibility and access to entities.

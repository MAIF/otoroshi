...
Then click on the `Check connection`. This should ouput the same result as the previous part. Save the global configuration and navigate to [http://otoroshi.oto.tools:8080/bo/dashboard/stats](http://otoroshi.oto.tools:8080/bo/dashboard/stats).

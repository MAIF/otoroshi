...
When Otoroshi is running, you can backup the global configuration store from the UI. Navigate to your instance (in our case [http://otoroshi.oto.tools:8080/bo/dashboard/dangerzone](http://otoroshi.oto.tools:8080/bo/dashboard/dangerzone)) and scroll to the bottom page. 

Click on `Full export` button to download the full global configuration.

### Import a datastore from file via the danger zone

When Otoroshi is running, you can recover a global configuration from the UI. Navigate to your instance (in our case [http://otoroshi.oto.tools:8080/bo/dashboard/dangerzone](http://otoroshi.oto.tools:8080/bo/dashboard/dangerzone)) and scroll to the bottom of the page. 

...
Once started, you can open a browser on [http://localhost:8080](http://localhost:8080) and click on `Administration Console`. Log to your instance with `admin/admin` as credentials.
...
1. Then click on the **Login using third-party** button (or navigate to [http://otoroshi.oto.tools:8080](http://otoroshi.oto.tools:8080))

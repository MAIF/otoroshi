...
- Go ahead, and navigate to [http://otoroshi.oto.tools:8080](http://otoroshi.oto.tools:8080)
...
- Then click on the **Login using third-party** button (or navigate to [http://otoroshi.oto.tools:8080/backoffice/auth0/login](http://otoroshi.oto.tools:8080/backoffice/auth0/login))

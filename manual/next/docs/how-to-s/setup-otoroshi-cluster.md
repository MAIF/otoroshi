...
Once launched, you can navigate to the [cluster view](http://otoroshi.oto.tools:8091/bo/dashboard/cluster). The cluster is now configured, you can see the 3 instances and some health informations on each instance.
...
no docker
:   > **Included file**: `../snippets/cluster-run-ha.sh`

...
<Tabs>
<TabItem value="no docker" label="no docker" default>

```text include=../snippets/cluster-run-ha.sh
```

</TabItem>
<TabItem value="docker (on linux)" label="docker (on linux)">

```text include=../snippets/cluster-run-ha.sh
```

</TabItem>
<TabItem value="docker (on macos)" label="docker (on macos)">

```text include=../snippets/cluster-run-ha.sh
```

</TabItem>
<TabItem value="docker (on windows)" label="docker (on windows)">

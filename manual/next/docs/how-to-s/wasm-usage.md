...
validator.rs
: > **Included file**: `../snippets/wasmo/validator.rs`

validator.js
: > **Included file**: `../snippets/wasmo/validator.js`

validator.ts
: > **Included file**: `../snippets/wasmo/validator.ts`

validator.js
: > **Included file**: `../snippets/wasmo/validator.js`

validator.go
: > **Included file**: `../snippets/wasmo/validator.go`
...
target.rs
: > **Included file**: `../snippets/wasmo/target.rs`

target.js
: > **Included file**: `../snippets/wasmo/target.js`

target.ts
: > **Included file**: `../snippets/wasmo/target.ts`

target.go
: > **Included file**: `../snippets/wasmo/target.go`
...
If you need to expose more than a HTML page, we highly recommend to use the [Zip Backend plugin](../how-to-s/zip-backend-plugin.md)

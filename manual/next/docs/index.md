...
You can download the latest build of Otoroshi as a [fat jar](./install/get-otoroshi.md#from-jar-file), as a [zip package](./install/get-otoroshi.md#from-zip) or as a [docker image](./install/get-otoroshi.md#from-docker).
...
now open your browser to <a href="http://otoroshi.oto.tools:8080/" target="_blank">http://otoroshi.oto.tools:8080/</a>, **log in with the credential generated in the logs** and explore by yourself, if you want better instructions, just go to the [Quick Start](./getting-started.md) or directly to the [installation instructions](./install/get-otoroshi.md)

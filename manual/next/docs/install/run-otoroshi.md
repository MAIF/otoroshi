...
If you want to provide your own config file, you can read [the documentation about config files](./setup-otoroshi.md).

You can also provide some ENV variable using the `--env` flag to customize your Otoroshi instance.

The list of possible env variables is available [here](./setup-otoroshi.md).

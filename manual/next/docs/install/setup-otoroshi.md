...
inmemory
:   > **Included file**: `../snippets/datastores/inmemory.conf` 

file
:   > **Included file**: `../snippets/datastores/file.conf` 

http
:   > **Included file**: `../snippets/datastores/http.conf` 

s3
:   > **Included file**: `../snippets/datastores/s3.conf` 

redis
:   > **Included file**: `../snippets/datastores/lettuce.conf` 

postgresql
:   > **Included file**: `../snippets/datastores/pg.conf` 

cassandra
:   > **Included file**: `../snippets/datastores/cassandra.conf` 
...
> **Included file**: `../snippets/reference.conf` 
...
> **Included file**: `../snippets/reference-env.conf` 

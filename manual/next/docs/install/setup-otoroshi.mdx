...
<div className="provider-card">
  ...
  <div className="provider-card-img"><img src="/img/docs/redis.png" alt="Redis" /></div>
...
<div className="provider-card">
  ...
  <div className="provider-card-img"><img src="/img/docs/inmemory.png" alt="In memory" /></div>
...
<div className="provider-card">
  ...
  <div className="provider-card-img"><img src="/img/docs/cassandra.png" alt="Cassandra" /></div>
...
<div className="provider-card">
  ...
  <div className="provider-card-img"><img src="/img/docs/postgres.png" alt="PostgreSQL" /></div>
...
<div className="provider-card">
  ...
  <div className="provider-card-img"><img src="/img/docs/filedb.png" alt="FileDB" /></div>
</div>
</div>

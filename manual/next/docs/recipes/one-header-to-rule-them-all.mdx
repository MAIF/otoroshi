...
<Image src="/img/docs/quick-tutorials/step-2.png" style={{width: "700px"}} />
...
<span style={{fontWeight: "bold"}}>Route plugins:</span>
<a className="badge" href="https://maif.github.io/otoroshi/manual/plugins/built-in-plugins.html#otoroshi.next.plugins.AdditionalHeadersIn">Additional Headers In</a>
<a className="badge" href="https://maif.github.io/otoroshi/manual/plugins/built-in-plugins.html#otoroshi.next.plugins.RemoveHeadersIn">Remove Headers In</a>
</div>
...
<Image src="/img/docs/quick-tutorials/step-4.png" style={{width: "700px"}} />
...
<div style={{display: "flex", alignItems: "center", gap: ".5rem"}}>
<a className="badge" href="https://maif.github.io/otoroshi/manual/plugins/built-in-plugins.html#otoroshi.next.plugins.OverrideHostHeader">Override Host Header</a>

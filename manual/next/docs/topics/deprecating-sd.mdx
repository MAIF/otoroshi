...
For more than 4 years, after the [rewrite of the proxy engine](./engine.mdx) in `v1.5.3` (Feb 14, 2022), Service Descriptors has been deprecated.
...
<Image src="/img/docs/sd-migration-logs.png" />

you will also have a popup displayed in the backoffice from time to time

<Image src="/img/docs/sd-migration-popup.png" />
...
<Image src="/img/docs/sd-migration-job-auto.png" />
...
<Image src="/img/docs/sd-migration-ui.png" />

and just confirm it

<Image src="/img/docs/sd-migration-ui-confirm.png" />

...
* [rest](#directives) : to call a http rest service with dynamic path params
* [permission](#directives) : to restrict the access to the sensitive field
* [graphql](#directives) : to call a graphQL service by passing a url and the associated query

...
:::note
**ReferenceGrant enforcement** is active. Cross-namespace backend references require a `ReferenceGrant` in the target namespace. See the [ReferenceGrant section](#referencegrant-cross-namespace-references-) for details and examples.
:::
## Troubleshooting

...
1. [Install a Wasmo](../tutorials/wasmo-installation.mdx)
2. [Use a WASM plugin](../tutorials/wasm-usage.mdx)
...
<Image src="/img/docs/wasm-plugin.png" title="screenshot of wasm plugin" />
...
```rust include=../snippets/wasmo/Cargo.toml
```

</TabItem>
<TabItem value="go.mod" label="go.mod">

```text include=../snippets/wasmo/go.mod
```

</TabItem>
<TabItem value="package.json" label="package.json">

```json include=../snippets/wasmo/package.json
```
...
<Image src="/img/docs/wasm-authz.png" title="screenshot of wasm authz" />
...
<Tabs>
<TabItem value="host.rs" label="host.rs" default>

```rust include=../snippets/wasmo/host.rs
```

</TabItem>
<TabItem value="host.go" label="host.go">

```go include=../snippets/wasmo/host.go
```

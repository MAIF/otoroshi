...
<Image src="/img/docs/generated-hows-to-secure-with-oauth1-provider.png" />
...
<Image src="/img/docs/hows-to-secure-app-with-oauth1-provider-input.png" />

The allow access to the user.

<Image src="/img/docs/hows-to-secure-app-with-oauth1-provider-trust.png" />

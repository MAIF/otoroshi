...
Backends can be defined locally within the API (in the `backends` array) or reference a global @ref:[stored backend](./backends.md) by its ID. This makes backends reusable across multiple APIs and routes.

| Property | Type | Description |
|----------|------|-------------|
| `id` | string | Unique identifier of the backend |
| `name` | string | Display name of the backend |
| `backend` | object | Full backend configuration (targets, root, rewrite, load balancing, health checks, TLS, etc.) following the @ref:[NgBackend](./backends.md) format |
...
| `plugins` | object | Plugin chain following the @ref:[NgPlugins](./routes.md) format |
...
* @ref:[Routes](./routes.md) - The route entity that API routes are converted into at runtime
* @ref:[Backends](./backends.md) - Global reusable backends that can be referenced by API backends
* @ref:[API Keys](./apikeys.md) - Credentials generated when subscribing with `apikey` access mode
* @ref:[Certificates](./certificates.md) - Certificates used with `mtls` access mode
* @ref:[JWT Verifiers](./jwt-verifiers.md) - Verifiers used with `jwt` and `oauth2-remote` access modes

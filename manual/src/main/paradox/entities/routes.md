...
* @ref:[Backends](./backends.md) - Reusable backend configurations
* @ref:[APIs](./apis.md) - Group multiple routes into a managed API
* @ref:[HTTP Listeners](./http-listeners.md) - Custom listeners that routes can be bound to
* @ref:[Route Templates](./route-templates.md) - Reusable route blueprints
* @ref:[Service Groups](./service-groups.md) - Group routes for API key authorization

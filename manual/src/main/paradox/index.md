...
```sh
curl -L -o otoroshi.jar 'https://github.com/MAIF/otoroshi/releases/download/v16.0.0-rc.3/otoroshi.jar'
...
```sh
docker run -p "8080:8080" maif/otoroshi:16.0.0-rc.3
```

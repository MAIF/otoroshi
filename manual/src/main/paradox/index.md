...
```sh
curl -L -o otoroshi.jar 'https://github.com/MAIF/otoroshi/releases/download/v1.5.3/otoroshi.jar'
...
```sh
docker run -p "8080:8080" maif/otoroshi:1.5.3
```

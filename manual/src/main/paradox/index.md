...
You can download the latest build of Otoroshi as a [fat jar](https://github.com/MAIF/otoroshi/releases/download/v1.4.13/otoroshi.jar), as a [zip package](https://github.com/MAIF/otoroshi/releases/download/v1.4.13/otoroshi-dist.zip) or as a @ref:[docker image](./getotoroshi/fromdocker.md).
...
```sh
docker run -p "8080:8080" -e "APP_DOMAIN=oto.tools" maif/otoroshi:1.4.13
```

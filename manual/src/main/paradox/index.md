...
You can download the latest build of Otoroshi as a [fat jar](https://dl.bintray.com/maif/binaries/otoroshi.jar/1.0.2/otoroshi.jar), as a [zip package](https://dl.bintray.com/maif/binaries/otoroshi-dist/1.0.2/otoroshi-dist.zip) or as a @ref:[docker image](./getotoroshi/fromdocker.md).

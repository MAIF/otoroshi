...
You can download the latest build of Otoroshi as a [fat jar](https://dl.bintray.com/maif/binaries/otoroshi.jar/latest/otoroshi.jar), as a [zip package](https://dl.bintray.com/maif/binaries/otoroshi-dist/latest/otoroshi-dist.zip) or as a @ref:[docker image](./getotoroshi/fromdocker.md).

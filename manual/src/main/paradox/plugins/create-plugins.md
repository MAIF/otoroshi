...
* @ref:[Plugin system](./plugins.md) - Plugin types reference and lifecycle steps
* @ref:[Built-in plugins](./built-in-plugins.md) - All built-in plugin references
* @ref:[Admin extensions](../topics/admin-extensions.md) - Extend Otoroshi with custom entities, routes, and UIs
* @ref:[WASM plugins](../topics/wasm-usage.md) - Write plugins in any language compiled to WASM

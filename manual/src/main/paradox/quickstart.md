...
curl -L -o otoroshicli https://dl.bintray.com/maif/binaries/mac-otoroshicli/1.4.4-dev/otoroshicli
# or if you use linux
curl -L -o otoroshicli https://dl.bintray.com/maif/binaries/linux-otoroshicli/1.4.4-dev/otoroshicli
# or if you use windows
curl -L -o otoroshicli.exe https://dl.bintray.com/maif/binaries/win-otoroshicli/1.4.4-dev/otoroshicli.exe

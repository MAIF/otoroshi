...
package object modules {
  ...
  class OtoroshiComponentsInstances(
    ...
    //[REMOVE SERVICEDESC] lazy val servicesController            = wire[ServicesController]
    ...
    //[REMOVE SERVICEDESC] lazy val ApiKeysFromServiceController  = wire[ApiKeysFromServiceController]
    ...
    //[REMOVE SERVICEDESC] lazy val canaryController              = wire[CanaryController]

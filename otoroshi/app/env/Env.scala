...
class Env(
  ...
  lazy val throttlingWindow: Int           = if (clusterConfig.mode.isWorker) 1 else configuration.getOptionalWithFileSupport[Int]("app.throttlingWindow").getOrElse(10)
  ...
  lazy val otoroshiVersion    = "16.23.0-dev"

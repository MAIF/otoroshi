...
object Http3ConversionUtil {
  def addHttp3ToHttpHeaders(streamId: Long, in: Http3Headers, out: HttpHeaders, version: HttpVersion, isTrailer: Boolean, isRequest: Boolean): Unit =
  ...
  def toFullHttpRequest(streamId: Long, http3Headers: Http3Headers, alloc: ByteBufAllocator, validateHttpHeaders: Boolean): FullHttpRequest =

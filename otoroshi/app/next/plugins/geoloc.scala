...
class NgGeolocationInfoHeader extends NgRequestTransformer {
  ...
  override def description: Option[String]                 =
    "This plugin will send informations extracted by the Geolocation details extractor to the target service in a header.".some
...
class NgGeolocationInfoEndpoint extends NgRequestTransformer {
  ...
  override def description: Option[String]                 =
    "This plugin will expose current geolocation informations on the following endpoint `/.well-known/otoroshi/plugins/geolocation`".some

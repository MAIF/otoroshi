...
public final class ServerReflectionGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<otoroshi.next.plugins.grpc.ServerReflectionRequest,
      otoroshi.next.plugins.grpc.ServerReflectionResponse> getServerReflectionInfoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ServerReflectionInfo",
      requestType = otoroshi.next.plugins.grpc.ServerReflectionRequest.class,
      responseType = otoroshi.next.plugins.grpc.ServerReflectionResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<otoroshi.next.plugins.grpc.ServerReflectionRequest,
      otoroshi.next.plugins.grpc.ServerReflectionResponse> getServerReflectionInfoMethod() {
    io.grpc.MethodDescriptor<otoroshi.next.plugins.grpc.ServerReflectionRequest, otoroshi.next.plugins.grpc.ServerReflectionResponse> getServerReflectionInfoMethod;
      ...
      synchronized (ServerReflectionGrpc.class) {
        if ((getServerReflectionInfoMethod = ServerReflectionGrpc.getServerReflectionInfoMethod) == null) {
          ServerReflectionGrpc.getServerReflectionInfoMethod = getServerReflectionInfoMethod =
              io.grpc.MethodDescriptor.<otoroshi.next.plugins.grpc.ServerReflectionRequest, otoroshi.next.plugins.grpc.ServerReflectionResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ServerReflectionInfo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  otoroshi.next.plugins.grpc.ServerReflectionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  otoroshi.next.plugins.grpc.ServerReflectionResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default io.grpc.stub.StreamObserver<otoroshi.next.plugins.grpc.ServerReflectionRequest> serverReflectionInfo(
        io.grpc.stub.StreamObserver<otoroshi.next.plugins.grpc.ServerReflectionResponse> responseObserver) {
  ...
  public static final class ServerReflectionStub
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<otoroshi.next.plugins.grpc.ServerReflectionRequest> serverReflectionInfo(
        io.grpc.stub.StreamObserver<otoroshi.next.plugins.grpc.ServerReflectionResponse> responseObserver) {
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
            new MethodHandlers<
              otoroshi.next.plugins.grpc.ServerReflectionRequest,
              otoroshi.next.plugins.grpc.ServerReflectionResponse>(
  ...
  private static abstract class ServerReflectionBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return otoroshi.next.plugins.grpc.ServerReflectionProto.getDescriptor();
    }

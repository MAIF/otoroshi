...
trait RefreshableUser {
  ...
  def updateToken(tok: JsValue)(using ec: ExecutionContext, env: Env): Future[Boolean]
}
...
case class BackOfficeUser(
  ...
  def save(duration: Duration)(using ec: ExecutionContext, env: Env): Future[BackOfficeUser] = {
...
trait BackOfficeUserDataStore extends BasicStore[BackOfficeUser] {
  def blacklisted(email: String)(using ec: ExecutionContext, env: Env): Future[Boolean]
  ...
  def sessions()(using ec: ExecutionContext, env: Env): Future[Seq[JsValue]]
  def tsessions()(using ec: ExecutionContext, env: Env): Future[Seq[BackOfficeUser]]
  def discardSession(id: String)(using ec: ExecutionContext, env: Env): Future[Long]

  ...
  val format: Format[ElasticAnalyticsConfig] = new Format[ElasticAnalyticsConfig] {
    override def writes(o: ElasticAnalyticsConfig) =
      Json.obj(
        ...
        "headers"       -> new JsObject(o.headers.view.mapValues(JsString.apply).toMap),
...
object Proxies {
  ...
  val format: Format[Proxies] = new Format[Proxies] {
      ...
      Try {
        GlobalConfig(
          ...
          quotasSettings = QuotasAlmostExceededSettings.format
            ...
            .getOrElse(QuotasAlmostExceededSettings(enabled = false, 0.8, 0.8)),

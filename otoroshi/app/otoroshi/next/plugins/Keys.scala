...
object Keys {
  ...
  val ContextualPluginsKey: TypedKey[NgContextualPlugins]       = TypedKey[NgContextualPlugins]("otoroshi.next.core.ContextualPlugins")
  ...
  val PreExtractedApikeyTupleKey: TypedKey[ApikeyTuple] = TypedKey[ApikeyTuple]("otoroshi.next.core.PreExtractedApikeyTuple")
  val BodyAlreadyConsumedKey: TypedKey[AtomicBoolean]     = TypedKey[AtomicBoolean]("otoroshi.next.core.BodyAlreadyConsumed")
  val JwtInjectionKey: TypedKey[JwtInjection]            = TypedKey[JwtInjection]("otoroshi.next.core.JwtInjection")
  val ResultTransformerKey: TypedKey[Function[Result,Future[Result]]]       = TypedKey[Function[Result, Future[Result]]]("otoroshi.next.core.ResultTransformer")
  val ResponseAddHeadersKey: TypedKey[Seq[(String, String)]]      = TypedKey[Seq[(String, String)]]("otoroshi.next.core.ResponseAddHeaders")
}

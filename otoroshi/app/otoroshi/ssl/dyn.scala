    ...
    val sslContext = new SSLContext(
      new SSLContextSpi() {
        ...
        private def configureProtocols(
          ...
          if (true) { // allowWeakProtocols is deprecated and not operative
        ...
        private def configureCipherSuites(
          ...
          val definedCiphers = sslConfig.enabledCipherSuites match {
            ...
            case None =>
              ...
              ).filter(existingCiphers.contains(_))
          }

          if (true) { // allowWeakCiphers is deprecated and not operative
            val deprecatedCiphers = Array(

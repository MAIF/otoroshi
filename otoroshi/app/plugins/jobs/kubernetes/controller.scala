...
import io.kubernetes.client.extended.controller.{reconciler, Controller, LeaderElectingController}
...
object KubernetesSupport {
  ...
  class OfficialSDKKubernetesController(config: KubernetesConfig) {
    ...
    def start(): OfficialSDKKubernetesController = {
      ...
      val controllerManager = ControllerBuilder
        .controllerManagerBuilder(informerFactory)
        .addController(buildController[V1Service, V1ServiceList]("otoroshi-controller-services", informerFactory) {
          params =>
        ...
        .addController(buildController[V1Endpoints, V1EndpointsList]("otoroshi-controller-endpoints", informerFactory) {
          params =>
        ...
        .addController(
          buildController[NetworkingV1beta1Ingress, NetworkingV1beta1IngressList](
            "otoroshi-controller-ingresses",
            informerFactory
          ) { params =>
            netApi.listIngressForAllNamespacesCall(
              null,
              null,
              null,
              null,

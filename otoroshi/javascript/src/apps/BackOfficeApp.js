    ...
    return (
      <>
        ...
        <div className="modal-footer">
          ...
          <button type="button" className="btn btn-success" onClick={(e) => this.props.ok(true)}>
      ...
      <Loader loading={this.state.loading}>
        <SidebarContext.Provider value={{
          ...
          <div style={{ height: 'calc(100vh - 52px)', overflow: 'hidden' }}>
            <div className="row" style={{ position: 'relative', width: '100vw' }}>
              <div className={`col-sm-${this.state.openedSidebar ? '2' : '1'} sidebar ${!this.state.openedSidebar ? 'sidebar--closed' : ''}`} id="sidebar">
                <i
              ...
              <div className={`col-sm-${this.state.openedSidebar ? '10' : '11'} main`}>
                <div className="row">

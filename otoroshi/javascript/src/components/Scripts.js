...
export class Scripts extends Component {
  ...
  render() {
    const url = this.props.type
      ? (this.props.excludedTypes ? `/bo/api/proxy/api/scripts/_list?type=${this.props.type}&excluded_types=${this.props.excludedTypes.join(",")}` : `/bo/api/proxy/api/scripts/_list?type=${this.props.type}`)
      : (this.props.excludedTypes ? `/bo/api/proxy/api/scripts/_list?excluded_types=${this.props.excludedTypes.join(",")}` : '/bo/api/proxy/api/scripts/_list');

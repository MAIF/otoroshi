    ...
    return fetch(`/bo/api/search/services`, {
      ...
      .then(results => {
        ...
        options.push({
          ...
          env: (
            <span>
<svg  xmlns="http://www.w3.org/2000/svg" className="monkeyMenu"
...
<g id="_x34_9a67235-e3a1-4929-8868-b30847745300">
	<g id="b11c2c3a-c434-45dc-a441-e60dd5d9d3f6">
		...
		<polygon className="st1" points="73.8,56.4 56,85.6 52.7,123.5 71,159.6 69.8,187.7 85.7,206.2 122.1,216.9 157.1,204.9 182.5,179
			196,116.3 218.9,76.5 152.4,40.7 130.6,35.1" fill="#FFFFFF"/>
		<path className="st0" fill="#343736" d="M213.9,111.2c6.8-2.9,13.7-5.7,20.5-8.5c-2.4-1-3.4-2-6.7-2.4c2.7-1.9,4.5-1.8,7.3-2.9
		...
		<path className="st0" fill="#343736" d="M93.2,91.2c0,0,17.2,2.4,19.4,3.2s0,7.7,0,7.7s0.3-1.8-5.3-4S90.7,97.7,87.3,99l-8.5,3.2l-2.1-0.9l-7-3.1
		...
		<path className="st0" fill="#343736" d="M110.9,147.6c0,0,0.6,1.9,3.6,2.2c1.6,0.1,3.2,0.6,4.7,1.3c0,0,2,3.3,2,4.9s0.8,15.7,0.8,15.7
			s-1.9-14-2.2-15.2s-3.7-2.2-5.8-3.3S110.9,147.6,110.9,147.6z"/>
		<path className="st0" fill="#343736" d="M134,147.6c0,0-0.6,1.9-3.6,2.2c-1.6,0.1-3.2,0.6-4.7,1.3c0,0-2,3.3-2,4.9s-0.8,15.7-0.8,15.7
			s1.9-14,2.2-15.2s3.7-2.2,5.8-3.3S134,147.6,134,147.6z"/>
		<path className="st0" fill="#343736" d="M113.6,97.5c0,0-3.4-3.8-7.1-5.2s-17.7,1.4-19.4,2.6s-5.6,4.9-4.2,6.7s-2.5,5.2-2.5,5.2s-7.5,0.8-8.2,3.3
		...
		<path className="st0" fill="#343736" d="M72.2,93.4c0,0-4.3,15.8,1.4,6.5s9.8-11.6,9.8-11.6s13.9-4.2,14.6-1.4s-4.3-10.5-4.3-10.5l2.8,2.5l6.9-9.6
		...
		<path className="st1" fill="#FFFFFF" d="M11,149.6c14.4-11.7,28.1-36.6,48.4-35.1l-3.4,2.7l3.4-0.7l-2.2,3.1l4.3-0.4c-1.7,2.1-2.8,4.5-3.2,7.2
		...
		<path className="st1" fill="#FFFFFF" d="M102.6,201c5.2,5.5,8.2,12.7,8.3,20.3l2-10.1c3.5,4.6,8.5,9,11.3,14.1c-4.2-4.7-7.2-11-10.8-16.2
		...
		<path className="st0" fill="#343736" d="M132.7,101.8c0,0,6.6-3.8,9.6-3.6s9.6-0.2,12,0.8s5.2,2.4,6.6,2.9s11,1.4,11,1.4l-7.3,1.4l4.7,2.3l-6.8,1.1
			l-4.4-1.3c0,0-1.8,0.7-5.2,2.3s-8.8,0.7-11.6,0c-2.9-0.5-5.8-0.8-8.7-0.9c0,0,3.1-2.8,3.3-3.5S132.7,101.8,132.7,101.8z"/>
		<path className="st0" fill="#343736" d="M130.6,179l-8.5,1.1c0,0-1.3-0.2-3.2-0.4c0.5-2.1,0.9-4.3,1-6.6c-0.1-2.6-0.1-11-2.2-13.5s-6-4.9-7.5-6

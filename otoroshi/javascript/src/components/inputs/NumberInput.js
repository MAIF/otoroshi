      ...
      <div className="form__group mb-20 grid-template-col-xs-up__1fr-5fr">
        ...
        <div className="">
          {(this.props.prefixFrom || this.props.suffixFrom) && (
            <div className="display--grid grid-template-col__1fr-auto" style={{ float: 'inherit' }}>
          ...
          {(this.props.prefixTo || this.props.suffixTo) && (
            <div className="display--grid grid-template-col__1fr-auto mt-5" style={{ float: 'inherit' }}>
              {this.props.prefixTo && (

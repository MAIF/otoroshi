  ...
  return (
    <div className="row mb-3">
      <label className="col-xs-12 col-sm-2 col-form-label">
        {label.replace(/_/g, ' ')} <i className="far fa-question-circle" data-toggle="tooltip" data-placement="top" title={_props.help} data-bs-original-title={_props.help} aria-label={_props.help} />
      </label>
            ...
            return (
              <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', width: '100%'}}>
                ...
                {ItemRenderer && <ItemRenderer 
                  ...
                  rawSchema={{ ...this.props.rawSchema, collapsable: false, noBorder: true, noTitle: true }}

      ...
      {!editingGroup && !isOnCreation && (
        <>
          ...
          <Tab
            title="Efficiency"
            icon="lightbulb"
            to="/extensions/green-score/efficiency"
            isActive={location.pathname === '/extensions/green-score/efficiency'}
          />
          ...
          <div className="ms-2 pb-1">
            <button
              ...
              onClick={() => {
                if (window.location.href !== '/extensions/green-score/groups/new') {
                  history.replace({

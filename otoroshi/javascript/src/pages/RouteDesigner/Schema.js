...
const ALGO_SETTINGS_FORM = ({ typeLabel = 'Algo.' }) => ({
    schema: {
        type: {
            type: type.object,
            ...
            options: [
                ...
                {
                    label: 'JWK Set (only for verification)', value: {
                ...
                {
                    label: 'RSASSA-PKCS1 + SHA from KeyPair', value: {
                ...
                {
                    label: 'ECDSA + SHA from KeyPair', value: {
        ...
        onlyExposedCerts: {
            ...
            visible: {
                ref: 'type',
                test: value => value === "KidAlgoSettings"
            }
        },
        size: {
            visible: {
                ref: 'type',
                test: value => value === "HSAlgoSettings"
            },
            type: type.number,
            format: format.select,
            label: "SHA Size",
...
export const COMPONENTS = [
    {
        ...
        props: {
            schema: {
                ...
                /* move subdomain.domain in hosts + handleLegacyDomain = false  */
            },
            flow: [
                "hosts",
                "paths",

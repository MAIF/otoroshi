...
export default ({ route }) => {
    ...
    const base = `/bo/dashboard/unnamed/${route.id}/`;
    ...
    return (
        <ul className="nav flex-column nav-sidebar">
            ...
            <li className="nav-item">
                <Link to={`/unnamed/${route.id}?tab=informations`} className="nav-link">
                    <i class="fas fa-file-alt" />  Informations
                </Link>
            </li>
            <li className="nav-item">
                <Link to={`/unnamed/${route.id}?tab=routes`} className="nav-link">
                    <i class="fas fa-road" />  Routes
                </Link>
            </li>
            <li className="nav-item">
                <Link to={`/unnamed/${route.id}?tab=flow`} className="nav-link">
                    <i class="fas fa-pencil-ruler" /> Designer
                </Link>
            </li>
            <li className="nav-item">
                <Link to={`/unnamed/${route.id}?tab=try-it`} className="nav-link">

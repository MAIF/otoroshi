...
export class ServicePage extends Component {
    ...
    this.setState({ loading: true }, () => {
      setTimeout(() => {
        ...
        if (ServicePage.__willCreateService) {
          ...
          this.setState(
            { service, originalService: service, changed: true, neverSaved: true },
            () => {
              this.props.setSidebarContent(this.sidebarContent(service.name));
            }
          );
        } else {
          BackOfficeServices.fetchService(
  ...
  exportService = (e) => {
    ...
    const json = JSON.stringify(
      { ...this.state.service, kind: 'proxy.otoroshi.io/ServiceDescriptor' },
      null,
      2
    );
        ...
        <form className="form-horizontal">
          ...
          >
            ...
            <BooleanInput
              ...
              help="Is pre-routing enabled for this service"

    ...
    "provide a way to crud main entities" in {
      {
        ...
        //[REMOVE SERVICEDESC] status2 mustBe 200
        status3 mustBe 200
        //[REMOVE SERVICEDESC] status4 mustBe 200
      }
      {
      ...
      //[REMOVE SERVICEDESC] {
        ...
        //[REMOVE SERVICEDESC] Reads.seq[ServiceDescriptor](using ServiceDescriptor._fmt).reads(res1).get.contains(testServiceDescriptor) mustBe true
      //[REMOVE SERVICEDESC] }
      //[REMOVE SERVICEDESC] {

  ...
  "Match and Project utils" should {
    ...
    "work on actual otoroshi event" in {
      ...
      val projection = Json.obj(
        ...
        "@service"           -> true,
        "@serviceId"         -> true,
        "client"             -> Json.obj("$pathIf" -> Json.obj("path" -> "identity.identity", "predicate" -> Json.obj("path" -> "identity.identityType", "value" -> "PRIVATEAPP"))),
        "status"             -> true,
        "path"               -> Json.obj("$path" -> "to.uri"),
        "method"             -> true,
        "user"               -> Json.obj("$pathIf" -> Json.obj("path" -> "identity.identity", "predicate" -> Json.obj("path" -> "identity.identityType", "value" -> "APIKEY"))),
        "from"               -> true,
        "duration"           -> true,
        "to"                 -> Json.obj("$path" -> "target"),
        "http"               -> Json.obj("$path" -> "to.scheme"),
        "protocol"           -> true,
        "size"               -> Json.obj("$path" -> "data.dataOut"),
        ...
        "service"            -> Json.obj("$path" -> "descriptor.name"),
        "host"               -> Json.obj("$path" -> "to.host"),
        "error"              -> "err",
        "errorMsg"           -> "gwError",
        "errorCause"         -> "gwError",

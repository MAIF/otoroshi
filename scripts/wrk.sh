...
if [ ! -f "$LOCATION/otoroshi.jar" ]; then
  wget -q --show-progress 'https://github.com/MAIF/otoroshi/releases/download/v1.4.16/otoroshi.jar'
fi 
...
if [ ! -f "$LOCATION/otoroshicli" ]; then
	wget -q --show-progress https://github.com/MAIF/otoroshi/releases/download/v1.4.16/otoroshi.jar/linux-otoroshicli
fi
